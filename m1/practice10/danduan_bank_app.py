...
# ==========================================
    ...
    # ======================================
        ...
        st.write(
            f"Current Balance: "
            f"**{danduan_bank_utils.format_currency(account.check_balance())}**"
        )
        ...
        if st.button(
            ...
            if not danduan_bank_utils.is_valid_amount(
                amount
            ):
                ...
                if success:
                    ...
                    danduan_bank_storage.update_account(
                        account
                    )
